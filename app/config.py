...
class Settings:
    ...
    llm_creator_distill_budget_mode: str = os.getenv("LLM_CREATOR_DISTILL_BUDGET_MODE", "auto").strip().lower()
    ...
    llm_quick_distill_budget_seconds: float = _float_env("LLM_QUICK_DISTILL_BUDGET_SECONDS", 1800.0)
    llm_deep_distill_budget_seconds: float = _float_env("LLM_DEEP_DISTILL_BUDGET_SECONDS", 3600.0)
    llm_batch_job_budget_seconds: float = _float_env("LLM_BATCH_JOB_BUDGET_SECONDS", 7200.0)
