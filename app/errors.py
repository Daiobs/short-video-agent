...
class ErrorCode:
    ...
    CREATOR_SET_NOT_FOUND = "CREATOR_SET_NOT_FOUND"
...
ERROR_MESSAGES = {
    ...
    ErrorCode.LOCAL_LOGIN_PAIR_CODE_INVALID: "配对码无效，请在 short-video-agent 设置中重新生成。",
    ErrorCode.LOCAL_LOGIN_PAIR_CODE_EXPIRED: "配对码已过期，请重新生成后完成配对。",
    ErrorCode.LOCAL_LOGIN_STATE_NOT_PAIRED: "扩展尚未与 short-video-agent 配对。",
    ErrorCode.LOCAL_LOGIN_STATE_AUTH_FAILED: "本机登录状态同步签名无效。",
    ErrorCode.LOCAL_LOGIN_STATE_TIMESTAMP_INVALID: "本机登录状态同步时间戳已过期。",
    ErrorCode.LOCAL_LOGIN_STATE_REPLAY: "该同步请求已处理，已拒绝重复请求。",
    ErrorCode.LOCAL_LOGIN_STATE_PAYLOAD_TOO_LARGE: "本机登录状态同步数据超过安全限制。",
    ErrorCode.LOCAL_LOGIN_STATE_INVALID: "本机登录状态同步数据格式无效。",
    ErrorCode.LOCAL_LOGIN_STATE_STORAGE_FAILED: "本机安全凭据无法读取或写入。",
    ErrorCode.LOCAL_LOGIN_STATE_VERSION_UNSUPPORTED: "扩展版本或同步协议版本不受支持。",
    ErrorCode.CREATOR_SET_NOT_FOUND: "创作者素材池不存在、已被清理或无法读取，请重新导入素材。",
