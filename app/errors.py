...
class ErrorCode:
    ...
    ITERATION_INDEX_INVALID = "ITERATION_INDEX_INVALID"
    ITERATION_CONTEXT_CHANGED = "ITERATION_CONTEXT_CHANGED"
    CURRENT_ITERATION_ACTIVE = "CURRENT_ITERATION_ACTIVE"
    ITERATION_LIMIT_REACHED = "ITERATION_LIMIT_REACHED"
    ITERATION_NOT_FOUND = "ITERATION_NOT_FOUND"
    ITERATION_ARTIFACT_NOT_READY = "ITERATION_ARTIFACT_NOT_READY"
    ITERATION_ARTIFACT_INVALID = "ITERATION_ARTIFACT_INVALID"
...
ERROR_MESSAGES = {
    ...
    ErrorCode.ITERATION_INDEX_INVALID: "创作迭代索引无效。为保护历史产物，已停止当前操作。",
    ErrorCode.ITERATION_CONTEXT_CHANGED: "当前创作轮次已变化，请在最新轮次重新执行操作。",
    ErrorCode.CURRENT_ITERATION_ACTIVE: "当前创作轮次尚未结束。请完成执行，或明确选择结束原因后开始下一轮。",
    ErrorCode.ITERATION_LIMIT_REACHED: "当前 Creator project 已达到 128 个创作轮次上限。",
    ErrorCode.ITERATION_NOT_FOUND: "没有找到指定的创作迭代。",
    ErrorCode.ITERATION_ARTIFACT_NOT_READY: "该创作迭代尚未生成对应产物。",
    ErrorCode.ITERATION_ARTIFACT_INVALID: "该创作迭代的产物无效或无法安全读取。",
}
