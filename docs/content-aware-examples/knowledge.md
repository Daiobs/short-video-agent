...
素材包结构化信息：
{
  ...
  "analysis_input": {
    ...
    "analysis_enrichment": {
      "asr": {
        "status": "success",
        "full_text": "观点是先明确问题，举例解释并按因果顺序论证。"
      }
    },
    "analysis_focus": {
      "version": 1,
      "initial_category": "knowledge",
      "primary": "knowledge",
      "label": "知识 / 观点",
      "source": "auto",
      ...
      "auxiliary": [],
      "questions": [
        "核心观点、论据、案例或类比是什么？按表达顺序拆解。",
        "区分来源的说法和已验证事实；指出论证缺口。",
        "可迁移哪种解释结构，而不是机械复制结论？"
      ],
      "section_order": [
        "script_structure",
...
{"initial_category": "knowledge", "primary": "knowledge", "label": "知识 / 观点", "source": "auto", "reason": "根据标题及已有文本初判表达方式；题材不等于已观察到的画面。", "auxiliary": []}
核心观点、论据、案例或类比是什么？按表达顺序拆解。
区分来源的说法和已验证事实；指出论证缺口。
可迁移哪种解释结构，而不是机械复制结论？
...
输入信息：
{
  ...
  "content_category": "knowledge",
  "content_category_label": "知识 / 观点",
  "category_description": "重点拆观点强度、信息结构、例子、反常识和可讨论性。",
  "analysis_enrichment": {
    "asr": {
      "status": "success",
      "full_text": "观点是先明确问题，举例解释并按因果顺序论证。"
